...
class QueensPlacement
{
    ...
    {
        return queen1.Item1 == queen2.Item1 ||
               queen1.Item2 == queen2.Item2 ||
               Math.Abs(queen1.Item1 - queen2.Item1) == Math.Abs(queen1.Item2 - queen2.Item2);
    }
    ...
    static void DisplayChessboard(Tuple<int, int>[] queens)
    {
        ...
        for (int i = 0; i < boardSize; i++)
        {
            ...
            {
                Console.Write(Array.IndexOf(queens, Tuple.Create(i, j)) != -1 ? "X " : "0 ");
            }
